        ...
        <header>
            ...
            <div class="top-navbar container-fluid">
                <div class="menu-mb">
                    ...
                    <a class="<?=in_array($routeName, ["product", "product-detail", 'search']) ? "active" : ""?>" href="<?=$router->generate('product')?>">Sản phẩm</a>
        ...
        <nav class="navbar navbar-default desktop-menu">
            <div class="container">
                <ul class="nav navbar-nav navbar-left hidden-sm hidden-xs">
                    ...
                    <li class="<?=in_array($routeName, ["product", "product-detail", 'search'])  ? "active" : ""?>"><a href="<?=$router->generate('product')?>">Sản phẩm </a></li>
